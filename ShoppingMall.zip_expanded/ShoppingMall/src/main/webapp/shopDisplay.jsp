        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="shop" items="${listShop}">
                <tr>
                    ...
                    <td><c:out value="${shop.college}" /></td>
                    <td><c:out value="${shop.roll}" /></td>
                    <td><c:out value="${shop.qualification}" /></td>
                    <td><c:out value="${shop.course}" /></td>
                    <td>
                    	<button class="btn btn-success"><a style="color:white;" href="shop?action=edit&id=<c:out value='${shop.id}' />">Edit</a></button>
                    	&nbsp;&nbsp;&nbsp;&nbsp;
                    	<button class="btn btn-danger"><a style="color:white;" href="shop?action=delete&id=<c:out value='${shop.id}' />" onclick="return confirm('Do you want to delete?')">Delete</a></button>                            	
                    </td>
                </tr>
            </c:forEach>
        </table>
