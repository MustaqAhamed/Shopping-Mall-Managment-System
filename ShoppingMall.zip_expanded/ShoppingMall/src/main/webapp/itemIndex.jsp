	...
	<center>
        ...
        <table border="1" cellpadding="5">
            ...
            <tr>
                <th>Price (₹) </th>
                <td>
                	<input type="text" name="college" size="45"
                			value="<c:out value='${item.college}' />"
                	/>
                </td>
            </tr>
            <tr>
                ...
                <td>
                	<input type="date" name="roll" size="45"
                			value="<c:out value='${item.roll}' />"
                	/>
                </td>
            </tr>
            <tr>
                <th>Expiry Date</th>
                <td>
                	<input type="date" name="qualification" size="45"
                			value="<c:out value='${item.qualification}' />"
                	/>
                </td>
            </tr>
            <tr>
                <th>Category</th>
                <td>
                	<input type="radio" id="clothing" name="course" size="45" value="clothing">
					<label for="clothing">Clothing</label><br>
					<input type="radio" id="mob" name="course" size="45" value="mobiles">
					<label for="mob">Mobiles</label><br>
					<input type="radio" id="acc" name="course" size="45" value="accessories">
