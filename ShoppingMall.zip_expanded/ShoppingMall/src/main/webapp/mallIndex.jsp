    ...
    <div align="center">
        ...
        <table border="1" cellpadding="5">
            ...
            <tr>
                ...
                <td>
                	<input type="text" name="college" size="45"
                			value="<c:out value='${mall.college}' />"
                	/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th>Category</th>
                <td>
                	<input type="radio" id="reg" name="qualification" size="45" value="regional">
					<label for="reg">Regional</label><br>
					<input type="radio" id="sup" name="qualification" size="45" value="super regional">
